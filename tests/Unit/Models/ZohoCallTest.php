...
class ZohoCallTest extends TestCase
{
    ...
    public function test_create_converts_numeric_minutes_to_hms(): void
    {
        ...
        Http::assertSent(fn ($request) => $request->data()['data'][0]['Call_Duration'] === '00:30:00');
    }

    public function test_create_converts_numeric_string_minutes_to_hms(): void
    {
        $this->fakeCallsCreate();
    ...
    public function test_create_handles_minutes_over_one_hour(): void
    {
        ...
        Http::assertSent(fn ($request) => $request->data()['data'][0]['Call_Duration'] === '02:05:00');
    }

    public function test_create_passes_through_already_formatted_hms(): void
    {
        $this->fakeCallsCreate();

        ZohoCall::create(['Call_Duration' => '01:02:05']);

        Http::assertSent(fn ($request) => $request->data()['data'][0]['Call_Duration'] === '01:02:05');
    }

    public function test_create_promotes_mm_ss_to_hh_mm_ss(): void
    {
        $this->fakeCallsCreate();

        ZohoCall::create(['Call_Duration' => '5:30']);

        Http::assertSent(fn ($request) => $request->data()['data'][0]['Call_Duration'] === '00:05:30');
    }
    ...
    public function test_upsert_normalizes_duration(): void
    {
        ...
        Http::assertSent(fn ($request) => $request->data()['data'][0]['Call_Duration'] === '00:45:00');
    }
    ...
    public function test_update_multiple_normalizes_each_record(): void
    {
        ...
        Http::assertSent(function ($request) {
            ...
            return $rows[0]['Call_Duration'] === '00:30:00'
                && $rows[1]['Call_Duration'] === '00:02:15';
        });
    }
}
